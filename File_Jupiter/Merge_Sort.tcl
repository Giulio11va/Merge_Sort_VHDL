...
#
# Block_Design.tcl: Tcl script for re-creating project 'Block_Design'
#
# Generated by Vivado on Mon Feb 12 18:11:50 +0100 2024
...
#
#    "C:/Users/lotto/Desktop/Consegna/Block_Design/Block_Design.srcs/sources_1/bd/B_Design/B_Design.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Block_Design/Block_Design.srcs/sources_1/bd/B_Design/B_Design.bd"]"\
  ]
  foreach ifile $files {
...
if { [get_property IS_LOCKED [ get_files -norecurse B_Design.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../Block_Design/Block_Design.gen/sources_1/bd/B_Design/hdl/B_Design_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse B_Design.bd] -top]
...
set_property -name "top" -value "B_Design_wrapper" -objects $obj
