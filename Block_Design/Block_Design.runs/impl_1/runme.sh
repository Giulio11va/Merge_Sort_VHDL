...
HD_PWD='C:/Users/lotto/Desktop/Consegna/Block_Design/Block_Design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log B_Design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source B_Design_wrapper.tcl -notrace
