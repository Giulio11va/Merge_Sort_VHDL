...
HD_PWD='C:/Users/lotto/Desktop/Consegna/Block_Design/Block_Design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log B_Design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source B_Design_wrapper.tcl
